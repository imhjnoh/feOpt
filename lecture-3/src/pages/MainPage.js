...
function MainPage(props) {
  ...
  useEffect(() => {
    ...
    observer.observe(second.current);
    observer.observe(third.current);
    ...
    <div className="MainPage -mt-16">
      ...
      <div className="mx-auto">
        ...
        <TwoColumns
          bgColor={"#f4f4f4"}
          columns={[
            <img data-src={main_items} ref={first} />,
            <Meta
              title={"Items"}
              content={
        ...
        <TwoColumns
          ...
          columns={[
            <Meta
              ...
              btnLink={"/part"}
            />,
            <img data-src={main_parts} ref={second} />,
          ]}
          mobileReverse={true}
        />
        <TwoColumns
          bgColor={"#f4f4f4"}
          columns={[
            <img data-src={main_styles} ref={third} />,
            <Meta
              title={"Riding Styles"}
              content={
